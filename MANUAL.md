...
| Plan | ราคา | เหมาะกับ |
|---|---|---|
| **Free** | ฟรี | ทดลองใช้ จำกัดข้อความ/วัน |
| **Pro** | $20/เดือน | ใช้คนเดียว — แนะนำสำหรับ personal use |
| **Team** | $25/user/เดือน | **แนะนำสำหรับทีม** — billing รวม, limit สูงกว่า Pro |

> 💡 ถ้าทีมใช้งานหนัก แนะนำ **Team Plan** — บริหาร account รวมกันได้ง่าย
> แต่ละคนยังใช้ account ของตัวเองอยู่ครับ ไม่ต้อง share login
...
> ⚠️ **สำคัญ — Write Permission**: ถ้าต้องการให้ Claude push ไฟล์ใหม่เข้า repo ได้โดยตรง
> ไปที่ [github.com/settings/installations](https://github.com/settings/installations)
> → Anthropic Claude → Configure → Contents: **Read and write**
...
### ✅ ตัวอย่างที่ 3: Hyper-V Failover Cluster

```
ช่วยหา template hyper-v-failover-cluster.md จาก repo
github.com/nutbadbot/diagram-templates
ปรับสำหรับลูกค้า:
- Node 1: [hostname] Windows Server 2022
- Node 2: [hostname] Windows Server 2022
- Storage: [SAN model] iSCSI
- CSV: 3 volumes ([ขนาด])
- VM หลัก: [รายการ]
```

### ✅ ตัวอย่างที่ 4: เปลี่ยน vendor ใน diagram
...
A: Claude (Pro/Team plan) ไม่เอา conversation ไป train — แต่ถ้าเป็นข้อมูลลับมากให้ใช้ placeholder แทนชื่อจริง
...
### Q: Claude push ไฟล์เข้า GitHub repo ไม่ได้ ทำยังไง?
A: GitHub connector ต้องการ Write permission ครับ — ไปที่ [github.com/settings/installations](https://github.com/settings/installations) → Anthropic Claude → Configure → Contents: **Read and write**
...
**Version**: 2.1 — อัปเดต Plan table (Pro/Team), เพิ่ม GitHub Write Permission guide, ตัวอย่าง Hyper-V
